...
public class OrderMenuView {
    ...
    public static void orderMenu() {
        ...
        Map<String, List<CartProduct>> cart = CartController.getUserCart();
        List<CartProduct> cartlist = cart.get(userId);
...
//                usingCoupon = getCouponDiscountRate();
            ...
            case 2:
                ...
                Payment pay = new Payment(userId, paymentMethod, 0, couponNumber);
        ...
        */
        // end of 장바구니 내역 출력
            ...
            /*// 장바구니 내역 출력
                //cartcontroller.Viewcart(String userId)
                //checkTotal
                int count2 = cartProducts.size();
                int totalPrice2 = 0;
                System.out.println("---------- 구매 목록: 총 " + count + " 개 ------------");
                for (int i = 0; i < count; i++) {
                    System.out.print((i + 1) + ". ");
...
//                    int discountRate = CouponController.selectCouponByNumber(couponNumber).getCouponDiscountRate();
                ...
                Payment payment = new Payment(userId, paymentMethod, paymentPrice, 0);
