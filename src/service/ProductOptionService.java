...
public class ProductOptionService {
    ...
    public void insertProductOption(ProductOption productOption) throws SQLException{
        ...
        if(result==0) throw new SQLException("에러: 상품옵션 입력 에러 / insertProductOption(ProductOption productOption)");
    }
    ...
    public void updateProductOption(ProductOption productOption) throws SQLException {
        ...
        if(result==0) throw new SQLException("에러: 상품옵션 업데이트 에러 / updateProductOption(ProductOption productOption)");
    }
    ...
    public void deleteProductOption(int productOptionNumber) throws SQLException {
        ...
        if(result==0) throw new SQLException("에러: 상품옵션 삭제 에러 / deleteProductOption(int productOptionNumber)");
    }
}
